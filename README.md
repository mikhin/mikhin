...
- **[NestJS plugin for Hey API](https://heyapi.dev/openapi-ts/plugins/nest)** - OpenAPI plugin that generates type-safe controller method signatures for NestJS. Contributed to Hey API.
